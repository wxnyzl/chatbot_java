...
public class MyLogImpl extends DefaultLogHandler {

    private static final Logger log = LoggerFactory.getLogger(MyLogImpl.class);
    ...
    public void logContent(String content) {
        // 使用log4j打印日志,同时记录
        log.info(content);
        //super.logContent("[com.chatbot.core.request.MyLogImpl]: " + content);
    }
